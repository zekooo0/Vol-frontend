const Privacy = () => {
  return (
    <div className="container py-20 text-lg" style={{ direction: 'ltr' }}>
      ...
      <br />
      <h2 className="text-xl font-medium">Interpretation and Definitions</h2>
      <br />
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Udd.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Arab World
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Udd, accessible from{' '}
            <a
              href="https://vol-frontend.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://vol-frontend.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h3 className="text-xl font-medium">Use of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-medium">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-xl font-medium">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="text-xl font-medium">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-medium">Security of Your Personal Data</h3>
      <p>
      ...
      <ul>
        <li>
          <p>By email: ahmedzakria102@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{' '}
            <a
              href="https://vol-frontend.vercel.app/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://vol-frontend.vercel.app/contact
            </a>
          </p>
        </li>
      </ul>
